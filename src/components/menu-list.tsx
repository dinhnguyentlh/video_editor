...
export default function MenuList() {
  ...
  return (
    <div
      ...
      className="w-14 py-2 absolute top-1/2 -translate-y-1/2 left-2.5 bg-zinc-950 rounded-lg shadow-lg flex flex-col   items-center overflow-y-auto h-full gap-4  "
      // nguyen fix class :absolute inset-0 h-full overflow-y-auto
    >
      <Button
        onClick={() => {
